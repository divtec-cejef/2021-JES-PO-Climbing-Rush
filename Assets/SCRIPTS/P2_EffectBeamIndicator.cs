...
public class P2_EffectBeamIndicator : MonoBehaviour
{
    ...
    public void playEffectBeam(Color colorIndicator)
    {
        ...
        effectBeam.transform.position = GameObject.Find("P2_prise " + numberOfTarget).transform.position + new Vector3(0, 0.1f, 0);
